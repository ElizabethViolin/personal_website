...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      title: "Article Categories - Elizabeth Taylor - 黄逸秋",
      description:
        "This page contains all the categories of articles available on this website.",
      url: `${server}/articles/categories`,
      siteName: "Elizabeth Taylor 黄逸秋- Passionate Builder of things",
      images: [
        {
          url: `${server}/images/user.png`,
          alt: "Elizabeth Taylor 黄逸秋 - Passionate Builder of things",
          width: 1200,
          height: 630,
        },
      ],
